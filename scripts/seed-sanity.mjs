...
async function seed() {
  ...
  await client.createOrReplace({
    ...
    pricingNote: "No hidden fees. Pay in 3 easy installments.",
    pricingPackages: [
      {
        _key: "p1",
        ...
        features: [
          "List of required documents for the visa",
          "Personalized application review",
          "Assistance in scheduling visa and NIE appointments",
          "Submission of application if applying in Spain",
      ...
      },
      {
        ...
        features: [
          ...
          "Translations of all your documents into Spanish (by a sworn and accredited translator)",
          "Assistance in scheduling TIE appointments",
        ],
        popular: true,
      },
    ],
    addOns: [
      { _key: "a1", name: "Appointments", price: "€100/appointment", description: "Assistance for NIE, TIE, and Regreso appointments and forms." },
      { _key: "a2", name: "Apostilles", price: "TBD", description: "Get your documents from the US, Canada, and Australia apostilled." },
      { _key: "a3", name: "Translations", price: "€30/page", description: "Get your documents translated by a sworn Spanish translator." },
    ],
    dependentFeeNote: "€500 per additional dependent",
    quickFacts: [
