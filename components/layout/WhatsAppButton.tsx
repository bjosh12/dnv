...
export default function WhatsAppButton({ phoneNumber }: { phoneNumber?: string }) {
  ...
  const message = encodeURIComponent(
    "Hi! I'm interested in getting a visa to live in Spain. Can you help?"
  );
  ...
  return (
    ...
    >
      {hovered && (
        <span className="bg-white text-[#1B3A6B] text-sm font-medium px-3 py-2 rounded-lg shadow-lg whitespace-nowrap">
          Chat with us!
        </span>
      )}
